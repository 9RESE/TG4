...
Contains strategy-specific calculation functions for market making signals.
...
def calculate_trend_slope(
    ...
    Thin wrapper around ws_tester.indicators.calculate_trend_slope that
    returns (slope_pct, is_trending) tuple for backward compatibility.
    ...
    """
    result = _calculate_trend_slope_lib(candles, lookback)
    return result.slope_pct, result.is_trending
...
__all__ = [
    ...
    'update_circuit_breaker_on_fill',
    'get_trading_session',
